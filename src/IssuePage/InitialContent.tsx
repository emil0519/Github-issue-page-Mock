...
function InitialContent({ data, type, count }: InitalCommentProps) {
  ...
  return (
    <>
      {" "}
      <section className="flex w-[100%] med:w-[62%]">
        <BigAvatar />
        <section className="flex w-[100%] flex-col">
          <section className="mr-auto ml-auto flex h-[max-content] w-[95%] flex-col rounded-md border-[1px] border-solid border-[#d4d6d9]">
